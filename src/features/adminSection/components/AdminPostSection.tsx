export const AdminPostSection = () => {
  return <section className="flex flex-col lg:flex-row items-start gap-5 mb-20">
   <div className="w-full lg:w-[50%] flex flex-col gap-4 cursor-pointer hover:bg-[#efeff1] p-5 rounded-md duration-75">
