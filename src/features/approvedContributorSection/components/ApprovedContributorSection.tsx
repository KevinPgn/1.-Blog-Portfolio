export const ApprovedContributorSection = () => {
  return <section className="px-10 flex items-center justify-center gap-10 flex-wrap my-5">
    <div className="flex flex-col gap-2 p-4 rounded-md hover:bg-[#1a1a1d] duration-75 cursor-pointer w-[500px]">
