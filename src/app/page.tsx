...
export default async function Home() {
  ...
  <div className="max-w-[1700px] mx-auto">
    ...
    <div className="flex items-center justify-between">
      <div className="relative w-[350px] max-md:w-[250px] max-md:mx-auto text-center my-5">
    ...
    <div className="relative w-[350px] max-md:w-[250px] max-md:mx-auto text-center my-7">
